...
namespace EdgeSense {
    namespace Sensors {
        ...
        : EnvSensors(LPS25HB_ENV_NAME, 0x5C, bus), temp(0.0f), pressure(0.0f) {}
        ...
        bool LPS25HB::initialize() {
            ...
            /* Hardware-level averaging to smooth out the pressure noise. */
        ...
        void LPS25HB::update() {
            ...
            /* Use address | 0x80 to enable the auto-increment feature of the sensor */
            uint8_t pBuffer[3];
